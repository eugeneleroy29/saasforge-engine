...
export function Navbar() {
  const { state, setTier, resetAllData, remainingTokens, tokenUsagePercent, openUpgradeModal } =
    useSaaS();
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-zinc-800/80 bg-zinc-950/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-block px-2 py-0.5 text-[10px] font-bold bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 rounded-full uppercase">
                AI SaaS Hub
              </span>
            </div>
            <p className="text-[11px] text-zinc-400 hidden sm:block">
              Multi-Tenant AI SaaS &amp; Token Metering Platform
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition cursor-pointer active:scale-95"
          ...
          <button
            onClick={() => openUpgradeModal()}
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md shadow-indigo-950 transition active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="p-2 rounded-xl text-zinc-400 hover:text-zinc-200 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition active:scale-95 cursor-pointer"
          >
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-2 border-t border-zinc-900 bg-zinc-950/60 text-xs">
        <span className="text-zinc-400 text-[11px] font-semibold">Demo Plan:</span>
